...
[软件下载](https://github.com/ByteFlow-art/labelImg2/releases) | [安装指南](#1-软件安装与快速启动) | [架构对比](#3-对标-chinakooklabelimg2-核心特性升级对比) | [功能详解](#4-核心功能深度解析) | [作业流程](#5-标准标注作业流程) | [快捷键表](#6-常用快捷键速查表) | [数据格式](#7-支持的标注数据格式) | [演进规划](#8-版本演进与路线图)
...
## 3. 对标 `chinakook/labelImg2` 核心特性升级对比
...
- 视频连续时序帧半监督自动跟踪与批注。
- 视频连续帧时序目标跟踪自动批注。
- 云端存储对象存储同步 (S3 / MinIO / OSS) 与团队多人协同审核。
